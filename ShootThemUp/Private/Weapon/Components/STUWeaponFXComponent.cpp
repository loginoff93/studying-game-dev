...
void USTUWeaponFXComponent::PlayInpactFX(const FHitResult& Hit)
{
	...
	//decal
	auto DecalComponent = UGameplayStatics::SpawnDecalAtLocation(GetWorld(), ImpactData.DecalData.Materia, ImpactData.DecalData.Size, Hit.ImpactPoint, Hit.ImpactNormal.Rotation());
